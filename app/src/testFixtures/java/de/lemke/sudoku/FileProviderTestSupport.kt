...
/** `FileProvider`'s static per-authority `sCache` outlives each Robolectric test's Application and its dirs. */
fun resetFileProviderCache() {
    // testFixtures has no compile-time dependency on androidx.core.
